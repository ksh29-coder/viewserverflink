...
echo ""
echo "🔍 Verification:"
if ! pgrep -f "ViewServerApplication\|mock-data-generator\|HoldingMarketValueJob\|OrderMarketValueJob\|npm run dev\|vite" > /dev/null; then
    echo "✅ All application services stopped"
else
    echo "⚠️  Some processes may still be running:"
    pgrep -f "ViewServerApplication\|mock-data-generator\|HoldingMarketValueJob\|OrderMarketValueJob\|npm run dev\|vite" | while read pid; do
